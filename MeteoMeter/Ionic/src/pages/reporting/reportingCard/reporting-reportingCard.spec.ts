...
describe('ReportingReportingCard Component', () => {
  let fixture: ComponentFixture<ReportingReportingCard>;
  let component: ReportingReportingCard;
  let spy: jasmine.Spy;
  ...
  beforeEach(async() => {
    fixture = TestBed.createComponent(ReportingReportingCard);
  ...
  it('ReportingReportingCard Component: should be created', fakeAsync(() => {
    expect(component instanceof ReportingReportingCard).toBeTruthy();
  }));

  it('ReportingReportingCard Component: should navigate to language page', fakeAsync(() => {
  ...
  it('ReportingReportingCard Component - onAdaptClass: should do nothing', fakeAsync(() => {
