...
/**
 * class: HighlightsBestContributorPageModule.
 * Highlights concern bestContributor layout.
...
@NgModule({
  ...
  imports: [
    ...
    IonicPageModule.forChild(HighlightsBestContributor)
  ],
  providers: [
    HighlightsAAAAA
  ]
})
export class HighlightsBestContributorPageModule {}
