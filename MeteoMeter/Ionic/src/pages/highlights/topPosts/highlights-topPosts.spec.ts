...
import { HighlightsTopPosts } from "./highlights-topPosts";
...
describe('HighlightsTopPosts Component', () => {
  let fixture: ComponentFixture<HighlightsTopPosts>;
  let component: HighlightsTopPosts;
  let spy: jasmine.Spy;
  ...
  beforeEach(async() => {
    fixture = TestBed.createComponent(HighlightsTopPosts);
  ...
  it('HighlightsTopPosts Component: should be created', fakeAsync(() => {
    expect(component instanceof HighlightsTopPosts).toBeTruthy();
  }));

  it('HighlightsTopPosts Component: should navigate to language page', fakeAsync(() => {
  ...
  it('HighlightsTopPosts Component - onShowCard: should do nothing', fakeAsync(() => {
  ...
  it('HighlightsTopPosts Component - onGetTopPosts: should use highlightsAAAAA service to GetTopPosts', fakeAsync(() => {
    ...
    spy = spyOn(component._highlightsAAAAA, 'getTopPosts').and.callThrough();
    component.onGetTopPosts(
    );
    flushMicrotasks();
    expect(spy).toHaveBeenCalledWith(
