...
/**
 * class: LoginUnknownMail.
 * Layout to show when the checkMail method of forgotPassword layout fails.
 * This is the component of that layout.
 * This component is generated from Concerns domain.
 */
@IonicPage({
  name: 'login-unknownMail',
  segment: 'login/unknownMail'
})
@Component({
  selector: 'login-unknownMail',
  templateUrl: 'login-unknownMail.html'
})
export class LoginUnknownMail {
  constructor(
