...
/**
 * class: ManageGroupsCreateGroupModal.
 * ManageGroups concern createGroup modal.
 * This is the component of that layout.
 * This component is generated from Concerns domain.
 */
@IonicPage({
  name: 'manageGroups-createGroupModal',
  segment: 'manageGroups/createGroupModal'
})
@Component({
  selector: 'manageGroups-createGroupModal',
  templateUrl: 'manageGroups-createGroupModal.html'
})
export class ManageGroupsCreateGroupModal {
  constructor(
   ...
   * @param group `CreateGroupaaaaaaaaaaaaaa`.
   * @returns A `Subscription<any>`.
   */
  public onSave(
    group: CreateGroupaaaaaaaaaaaaaa
  ) {
    return this._groupAAAAA.create(
      group
    ).subscribe();
  }
